...
Fields["Notat - Fritekst"].input("Tilpasset i xxx<newline><newline>Der er udleveret relevante vejledninger og givet instruktion.");
Fields['Notat - NavigatorTree'].select("Fabrikat");
Fields["Notat - Fritekst"].input("Licitationskode: <newline>HA-model: <newline>Tilbehør: <newline>Farve: <newline>Filter: <newline>Batteristr.: ");
Fields['Notat - NavigatorTree'].select("Programvalg");
Fields["Notat - Fritekst"].input("P1: <newline>P2: <newline>P3: <newline>P4: <newline><newline>Volumenkontrol: <newline>Programomskifter: ");
throw 1;
...
Dialog.info('header', 'Før Detect Clinician run flow', { 'timeout': 10 });
/*** Detect clinician ***/
Flow.run('Detect clinician test2', {} );
...
Dialog.info('header', 'Efter Detect Clinician run flow', { 'timeout': 10 });
...
var ProcedureCode1add2 ="MS01LA05";
...
var operationsbeskrivelse = "Anti-VEGF-injektion med Eylea o.dx.<newline>Der injiceres 0,05 ml Eylea 40 mg/ml, 3,5 mm bag limbus, ukompliceret.";
