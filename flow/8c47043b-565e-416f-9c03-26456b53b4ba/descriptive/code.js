...
try {
 var surgery = Dialog.input(
    procedurename, "Angiv valg",{maxDialogHeight: 600, buttons: [{ 'value': 'Ok' },{ 'value': 'Cancel', 'isCancel': true }],
       "dLaagdiameter": {
         "type": "MULTITEXT", 
         "prompt": "Lågdiameter o.dx:",
         'texts': [
         {'name': 'dld', 'suffix': "mm", 'value': "7,7", 'validation': {'isRequired': true, 'message': "Lågdiameter skal angives"} }]},
      
        "dLaagtykkelse": {
         "type": "MULTITEXT", 
         "prompt": "Lågtykkelse o.dx:",
         'texts': [
         {'name': 'dlt', 'suffix': "my", 'value': "130", 'validation': {'isRequired': true, 'message': "Lågtykkelse skal angives"} }]},
        ...
        "dLentikeldia": {
         "type": "MULTITEXT", 
         "prompt": "Lentikeldiameter o.dx:",
         'texts': [
         {'name': 'dld', 'suffix': "mm", 'validation': {'message': "Lentikeldiameter skal angives"} }]}, 
 
        "dLentikeltyk": {
         "type": "MULTITEXT", 
         "prompt": "Lentikeltykkelse o.dx:",
         'texts': [
         {'name': 'dlt', 'suffix': "my"}]}, 
      ...
      "sLaagdiameter": {
         "type": "MULTITEXT", 
         "prompt": "Lågdiameter o.sin:",
         'texts': [
         {'name': 'sld', 'suffix': "mm", 'value': "7,7", 'validation': {'isRequired': true, 'message': "Flapdiameter skal angives"} }]},
       
      "sLaagtykkelse": {
        "type": "MULTITEXT", 
        "prompt": "Lågtykkelse o.sin:",
        'texts': [
          {'name': 'slt', 'suffix': "my", 'value': "130", 'validation': {'isRequired': true, 'message': "Flapdiameter skal angives"} }]},
      ...
      "sLentikeldia": {
        "type": "MULTITEXT", 
        "prompt": "Lentikeldiameter o.sin:",
        'texts': [
          {'name': 'sld', 'suffix': "mm", 'validation': {'message': "Flapdiameter skal angives"} }]},  
      
        "sLentikeltyk": {
         "type": "MULTITEXT", 
         "prompt": "Lentikeltykkelse o.sin:",
         'texts': [
         {'name': 'slt', 'suffix': "my"}]},
...
/*** Operationsbeskrivelse ***/
  var t1 = "<newline><newline>Patienten fikserer på fiksationslyset under Visumax og vakuum etableres.<newline>Laseren aktiveres i SMILE-modus.<newline><newline>";
  var t2 = "<newline><newline>Låget åbnes oppefra med Sinsky-hook, lentiklen fridissekeres stumpt med flapløfter og fjernes med Kelman-McPherson-pincet.<newline>Der skylles under flappen med isoton saltvand. Låget udglattes med spyd og observeres under laserspaltelampen efter 1 minut.<newline>Øjet dryppes med ocgt. Oftaquix x 1 og ocgt. Voltaren x 1.<newline><newline><newline>";
  ...
  if (surgery.dKorrektion.dk0 !== undefined) {
    opbesk = 
      "SMILE o.dx." + 
      t1 + 
      "Lågdiameter: " + surgery.dLaagdiameter.dld + " mm" +
      "<newline>Lågtykkelse: " + surgery.dLaagtykkelse.dlt + " μm" + 
      "<newline>Korrektion: " + surgery.dKorrektion.dk0 + " sf. " + surgery.dKorrektion.dk1 + " x " + surgery.dKorrektion.dk2 + "°" +
      "<newline>Lentikeldiameter: " + surgery.dLentikeldia.dld + " mm" +
      "<newline>Lentikeltykkelse: " + surgery.dLentikeltyk.dlt + " μm" +
      t2;
  }
  if (surgery.sKorrektion.sk0 !== undefined) {
    opbesk = opbesk +
      "SMILE o. sin." + 
      t1 + 
      "Lågdiameter: " + surgery.sLaagdiameter.sld + " mm" +
      "<newline>Lågtykkelse: " + surgery.sLaagtykkelse.slt + " μm" + 
      "<newline>Korrektion: " + surgery.sKorrektion.sk0 + " sf. " + surgery.sKorrektion.sk1 + " x " + surgery.sKorrektion.sk2 + "°" +
      "<newline>Lentikeldiameter: " + surgery.sLentikeldia.sld + " mm" +
      "<newline>Lentikeltykkelse: " + surgery.sLentikeltyk.slt + " μm" +
      t2;
  }
