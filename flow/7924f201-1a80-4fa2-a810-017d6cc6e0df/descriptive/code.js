...
/*** Inputs  ***/
var procedurename = "Skeleoperation - esotropi";
var oculus = ["o.dx.","o.sin."];
var anaest = ["Peribulbær anæstesi", 
              "Retrobulbær anæstesi", 
              "Generel anæstesi"];
var indik = ["esotropi", 
             "dekompenserende esofori"];
var nj = ["Nej", "Ja"];
try {
  var surgery = Dialog.input(
    procedurename, "Angiv valg",{maxDialogWidth: 380, buttons: [{ 'value': 'Ok' },{ 'value': 'Cancel', 'isCancel': true }],
      "Eye": { "type": "RADIO", "prompt": "Øje:", "selectBetween": oculus, 'validation': {'isRequired': true, 'message': "Vælg øje"}},
      "Indikation": { "type": "RADIO", "prompt": "Indikation:", "selectBetween": indik},
      "Anaestesi": { "type": "RADIO", "prompt": "Anæstesi:", "value": anaest[0], "selectBetween": anaest, "orientation": "vertical"},
      "Epikrise": { "type": "RADIO", "prompt": "Standard epikrise:", "value": nj[1], "selectBetween": nj, "dependsOn": "Anaestesi=Generel anæstesi"},                            "medialis": {"type": "MULTITEXT", "prompt": "Operation:", 'texts': [
        {'name': 'tilbage',"prefix": "Rectus medialis lægges", "suffix": "mm tilbage.", 'validation': {'isRequired': true, 'message': "Længde skal angives"}}]},
      "lateralis": {"type": "MULTITEXT", "prompt": " ", 'texts': [
        {'name': 'forkortes', 'prefix': "Rectus lateralis forkortes", 'suffix': "mm.", 'validation': {'isRequired': true, 'message': "Længde skal angives"}} ]},
...
var operationsbeskrivelse = "Musculus rectus medialis lokaliseres. Denne lægges " + surgery.medialis.tilbage + " mm tilbage. Sutureres til sclera med Vicryl 6-0. Conjunctiva adapteret med Vicryl 7-0.<newline>Musculus rectus lateralis lokaliseres. Denne forkortes " + surgery.lateralis.forkortes + " mm. Sutureres til sclera ved muskelhæftet med Vicryl 6-0. Conjunctiva adapteret med Vicryl 7-0.";
...
/*** Resumé af forløbet   ***/
var resume = "Indlagt med henblik på " + sidig + "skeleoperation for " + surgery.Indikation + ".<newline>Musculus rectus medialis er tilbagelagt med " + surgery.medialis.tilbage + " mm, musculus rectus lateralis er forkortet med " + surgery.lateralis.forkortes + " mm.<newline>Operationen har været ukompliceret, og pt. er velbefindende ved udskrivelsen.";
