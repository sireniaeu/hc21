//************************************************************//
//*** Cosmic flow to initiate and update Epikrise template ***//
//************************************************************//
var StdRetry = 15;
...
/*****************************************************************************/
/*** Set type of note to Epikrise and create Epikrise if it does not exist ***/
/*****************************************************************************/
  
  var skabelontype = "Epikrise";
  try {
...
/********************/
  ...
  try {
    Fields["Notat - Afdeling Enhed"].select(".*SLB A130.*"); 
  } catch (e) {
...
//****************************************************//  
  ...
  Dialog.warn("Advarsel", "Automatisk oprettelse af epikrise afbrydes.");
}