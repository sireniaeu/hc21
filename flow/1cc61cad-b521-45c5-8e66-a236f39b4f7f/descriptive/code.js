...
/*** Set type of note   ***/
/**************************/
//**Notification.show('working', 'Manatee arbejder, vent...', 'Finder skabelon', {});
...
//*******************************//
//**Notification.show('working', 'Manatee arbejder, vent...', 'Skriver notat', {}); 
/*********************/
/*** Udarbejdet af ***/
/*********************/
...
/****************/
 if (AOoperatoer !== "N/A"){  
   try { 
    ...
    Dialog.warn("Advarsel", "'Operatør' kan ikke opdateres. Feltet findes muligvis ikke i notatskabelonen.", { 'timeout': 5 }); 
  } 
 }
...
/*** Diagnoser   ***/
/*******************/
//**Notification.show('working', 'Manatee arbejder, vent...', 'Koder diagnoser', {});
  if (AODiagnose1 !== "N/A"){
...
/*** Procedurer ***/
/******************/
//**Notification.show('working', 'Manatee arbejder, vent...', 'Koder procedurer', {});
/*** Procedure 1 ***/  
...
/*******************************/
  if (AOdictate !== "N/A"){
//**Notification.show('working', 'Manatee arbejder, vent...', 'Opretter diktat', {});
...
//*** Save draft ***//
//******************//   
if (AOgemkladde !== "N/A" && AOpreview === "N/A") {
  Fields["Gem kladde"].click();
} 
//**Notification.close('working');  
//****************************************************//  
