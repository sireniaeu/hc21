...
/*** Inputs  ***/
var procedurename = "Eylea";
var oculus = ["o.dx.","o.sin."];
var nj = ["Nej", "Ja"];
var comment = ["Kræver ekstra bedøvende dråber", "En del øjenuro", "Urolig på lejet", "Skal have beroligende medicin næste gang", "Sidder i kørestol, kan forflyttes med lidt hjælp","Sidder i kørestol, kræver forflytning med lift"];
...
try {
  ...
  var surgery = Dialog.input(
    procedurename, "Angiv valg",{buttons: [{ 'value': 'Ok' },{ 'value': 'Cancel', 'isCancel': true }],
      ...
      "Comments": { "type": "RADIO", "prompt": "Evt. bemærkning:", "selectBetween": comment, "orientation": "vertical"}
      });
...
var operationsbeskrivelse = "Anti-VEGF-injektion med Eylea o.dx.<newline>Der injiceres 0,05 ml Eylea 40 mg/ml, 3,5 mm bag limbus, ukompliceret.<newline><newline>" + surgery.Comments + ".";
