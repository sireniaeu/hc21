...
/*** Inputs  ***/
var procedurename = "Makulært hul";
...
var op = {
  "jv": { 
    text: "Operationsbeskrivelse."
      },
  "gm": { 
    text: "Der foretages vanlig 3-portsadgang 3,5 mm bag limbus med 25+ gauge teknik. Velplaceret vandindføring.<newline>Kort kernevitrektomi. Der farves med Kenalog, og bagre hyaloid løsnes ud mod periferien. Herefter supplerende vitrektomi under indentering. Ingen huller eller rifter. Herefter gøres bagre kapsulotomi med vitrektor.Der farves med ILM-Blue, og ILM peeles ukompliceret.<newline>Væske-/luftskifte.<newline>Atmosfærisk luft skiftes til 20% SF6 til passende tension.<newline>De sklerale porte fjernes, og sklerotomierne er tætte.<newline>Afslutningsvist 0,5 ml Marcain efterfulgt af 0,5 ml Hexamycin og 0,5 ml Dexaven subkonjunktivalt."
      },
    "jw": { 
    text: "Der foretages vanlig 3-portsadgang 3,5 mm bag limbus med 25+ gauge teknik. Velplaceret vandindføring.<newline>Kort kernevitrektomi. Der farves med Kenalog, og bagre hyaloid løsnes ud mod periferien. Herefter supplerende vitrektomi under indentering. Ingen huller eller rifter. Bagre kapsel spaltes med vitrektor.<newline>Der farves med ILM-Blue, og ILM peeles ukompliceret.<newline>Væske-/luftskifte.<newline>Atmosfærisk luft skiftes til 20 % SF6 til passende tension.<newline>De sklerale porte fjernes, og sklerotomierne er tætte.<newline>Afslutningsvist 0,5 ml Marcain efterfulgt af 0,5 ml Hexamycin og 0,5 ml Dexaven subkonjunktivalt."
      },
    "nlø": { 
    text: "Der foretages vanlig 3-portsadgang 3,5 mm bag limbus med 25+ gauge teknik. Velplaceret vandindføring.<newline>Kort kernevitrektomi. Der farves med Kenalog, og bagre hyaloid løsnes ud mod periferien. Herefter supplerende vitrektomi under indentering. Ingen huller eller rifter. Herefter gøres bagre kapsulotomi med vitrektor.<newline>Der farves med ILM-Blue, og ILM peeles ukompliceret.<newline>Væske-/luftskifte.<newline>Atmosfærisk luft skiftes til 15% SF6 til passende tension.<newline>De sklerale porte fjernes, og sklerotomierne er tætte.<newline>Afslutningsvist 0,5 ml Marcain efterfulgt af 0,5 ml Hexamycin og 0,5 ml Dexaven subkonjunktivalt.<newline>Øjenklap."
      },
  "ml": { 
    text: "Der foretages vanlig 3-portsadgang 3,5 mm bag limbus med 25+ gauge instrumenter.<newline>Velplaceret bagkammerlinse samt vandindføring.<newline>Kort kernevitrektomi. Herefter farves med Kenalog.<newline>Bagre hyaloid afløsnes/ er afløsnet. Der vitrektomeres i periferien under indentering. Der er ingen huller eller rifter. Med vitrektor gøres bagre kapsulotomi.<newline>Der farves med ILM-Blue  og foretages uproblematisk ILM-peeling til karbuerne.<newline>Herefter væske-/luftskifte. Atmosfærisk luft skiftes til 10 % SF6.<newline>De sklerale porte fjernes og er tætte.<newline>Afslutningsvist 0,5 ml Marcain efterfulgt af 0,5 ml Hexamycin og Dexaven subtenonalt.<newline>Øjenklap."
        }
};
