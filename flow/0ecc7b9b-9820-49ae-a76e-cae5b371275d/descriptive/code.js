...
/*** Inputs  ***/
var procedurename = "Ptoseoperation";
...
try {
  var surgery = Dialog.input(
    procedurename, "Angiv valg",{buttons: [{ 'value': 'Ok' },{ 'value': 'Cancel', 'isCancel': true }],
      ...
      "Skin": { "type": "RADIO", "prompt": "Hudexcision:", "selectBetween": nj, "value": nj[1]},
...
/*** Anaestesi ***/
var anaestesi = "Infiltrationsanæstesi.";
...
if (surgery.Skin === nj[1])
{
var ProcedureCode2 = "KCBB10";
} else {
...
if (surgery.Skin === nj[1])
{
var derma = "Overskydende hud excideres. ";
} else {
derma = "";
}
var op = {
  "jv": { 
    text: "Hudincision i globelinjen. " + derma + "Tarsus og levatorkompleks frilægges. I tarsus' øvre kant sættes to enkelte Mersilene 6-0 knudesuturer, som vidererføres op gennem m. levator palpebrae.<newline>Øjenlågshøjde og -kontur justeres til passende niveau. Vicryl 6-0 fra orbiculariskanter med snip fra aponeurosekanten. Hud adapteres med Ethilon 6-0."
      },
  "db": { 
    text: "Hudincision i globelinjen. " + derma + "Tarsus og levatorkompleks frilægges. I tarsus' øvre kant sættes to enkelte Mersilene 6-0 knudesuturer, som vidererføres op gennem m. levator palpebrae.<newline>Øjenlågshøjde og -kontur justeres til passende niveau. Vicryl 6-0 fra orbiculariskanter med snip fra aponeurosekanten. Hud adapteres med Ethilon 6-0."
      },
  "ng": { 
    text: "Hudincision i globelinjen. " + derma + "Tarsus og levatorkompleks frilægges. I tarsus' øvre kant sættes to enkelte Mersilene 6-0 knudesuturer, som vidererføres op gennem m. levator palpebrae.<newline>Øjenlågshøjde og -kontur justeres til passende niveau. Hud adapteres med Ethilon 6-0."
      },
  "mk": { 
    text: "Hudincision i globelinjen. " + derma + "Tarsus og levatorkompleks frilægges. I tarsus' øvre kant sættes to enkelte Vicryl 6-0 knudesuturer, som vidererføres op gennem m. levator palpebrae.<newline>Øjenlågshøjde og -kontur justeres til passende niveau. Hud adapteres med Ethilon 6-0."
        }
};
...
/*** Konklusion og plan ***/
var konklusionogplan = "Suturfjernelse her om ca. 1 uge.<newline>Kontroltid hos " +clinician.name+ " om ca. 6 uger.";
